...
def main():
    ...
    normalized_output = multi_shadow_find([shadow_A, shadow_B], num_cores=2)
    ...
    axs[2].imshow(np.array(multi_shadow_fig.canvas.renderer.buffer_rgba()))
    axs[2].set_title("Multi Shadow")
